<x-layouts::guest>
    <div class="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        <header class="mb-10 border-b border-zinc-800 pb-8">
            ...
            <p class="max-w-xl text-sm leading-relaxed text-zinc-400">A zero-budget, open-source streaming companion powered by live metadata APIs. This page explains the technical architecture for developers and contributors.</p>
            <div class="mt-4 flex flex-wrap gap-2">
                ...
                <span class="rounded bg-teal-900/40 px-2 py-0.5 text-xs font-semibold uppercase tracking-wider text-teal-400">Livewire</span>
        ...
        <div class="prose-invert prose-sm max-w-none [&_h2]:mb-3 [&_h2]:mt-10 [&_h2]:font-serif [&_h2]:text-xl [&_h2]:font-bold [&_h3]:mb-2 [&_h3]:mt-6 [&_h3]:text-sm [&_h3]:font-bold [&_li]:text-zinc-300 [&_p]:mb-3 [&_p]:leading-relaxed [&_p]:text-zinc-300 [&_strong]:text-white [&_ul]:mb-4 [&_ul]:list-disc [&_ul]:pl-5">
            ...
            <h2>Overview</h2>
            <p>{{ config('app.name') }} is a monolithic PHP application that proxies TMDB for metadata, stores user data in a SQL database, and delegates video playback to an embedded client-side player that fetches streams from external sources. No media is stored or transcoded locally.</p>
            ...
            <ul>
                ...
                <li><strong>Aggressive caching</strong> — TMDB responses cached in the application cache store.</li>
            ...
            <div class="mb-6 overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="text-zinc-300 [&_td]:border-b [&_td]:border-zinc-800 [&_td]:py-2 [&_td]:pr-4">
                        <tr><td class="font-medium text-white">Backend</td><td class="text-teal-400">PHP 8.4</td><td class="text-zinc-500">Routing, caching, auth, API proxy</td></tr>
                        <tr><td class="font-medium text-white">Frontend</td><td class="text-teal-400">Livewire + Flux UI</td><td class="text-zinc-500">Server-rendered reactive components</td></tr>
                        <tr><td class="font-medium text-white">Styling</td><td class="text-teal-400">Tailwind CSS</td><td class="text-zinc-500">Utility-first, zero runtime cost</td></tr>
                        <tr><td class="font-medium text-white">Database</td><td class="text-teal-400">SQLite / Postgres</td><td class="text-zinc-500">Users, favorites, watch history, cache</td></tr>
                        ...
                        <tr><td class="font-medium text-white">Auth</td><td class="text-teal-400">Fortify</td><td class="text-zinc-500">Registration, login, 2FA</td></tr>
                        <tr><td class="!border-b-0 font-medium text-white">Caching</td><td class="!border-b-0 text-teal-400">Application cache</td><td class="!border-b-0 text-zinc-500">Configurable TTL per endpoint</td></tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="mt-12 border-t border-zinc-800 pt-6">
            <p class="text-xs text-zinc-600">{{ config('app.name') }} is an open-source project. Built with PHP(Laravel), Livewire, and TMDB.</p>
        </div>
    </div>
</x-layouts::guest>
